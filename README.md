...
This package is greatly inspired by [@jayesbe](https://github.com/jayesbe)'s amazing [react-native-cacheable-image](https://github.com/jayesbe/react-native-cacheable-image) but uses rn-fetch-blob instead of react-native-fetch-blob as it conflicts with another library that uses rn-fetch-blob when building.
